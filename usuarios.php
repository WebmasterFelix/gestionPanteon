...
<html lang="en">
	...
	<body class="hold-transition sidebar-mini layout-fixed">
				...
				<section class="content">
					<div class="card">
						...
						<div class="card-body">
							...
							<?php
								include("assets/modal/usuarios/registro_usuarios.php");
								include("assets/modal/usuarios/editar_usuarios.php");
								include("assets/modal/usuarios/cambiar_password.php");
							?>
						</div>
					</div>
				</section>
		...
		<script src="assets/js/usuarios.js?v=<?php echo $version;?>"></script>
	</body>
</html>