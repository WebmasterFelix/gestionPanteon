...
<html lang="en">
	...
	<body class="hold-transition sidebar-mini layout-fixed">
				...
				<section class="content">
					<div class="card">
						...
						<div class="card-body">
							...
							<?php
								include("assets/modal/categorias/registro_categoria.php");
								include("assets/modal/categorias/editar_categoria.php");
							?>
						</div>
					</div>
				</section>
		...
		<script src="assets/js/categorias.js?v=<?php echo $version;?>"></script>
	</body>
</html>