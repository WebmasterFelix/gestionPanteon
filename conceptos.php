...
<html lang="en">
	...
	<body class="hold-transition sidebar-mini layout-fixed">
			...
			<div class="content-wrapper">
				...
				<section class="content">
					<div class="card">
						...
						<div class="card-body">
							<table id="conceptos" class="table table-bordered table-striped">
								<thead>
									<tr>
										<th width="10%">#</th>
										<th width="10%">Código SAP</th>
							...
							<?php
								include("assets/modal/conceptos/registro_conceptos.php");
								include("assets/modal/conceptos/editar_conceptos.php");
							?>
						</div>
					</div>
				</section>
		...
		<script src="assets/js/conceptos.js?v=<?php echo $version;?>"></script>
	</body>
</html>